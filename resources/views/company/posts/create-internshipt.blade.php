...
@section('content')
    ...
    <section class="post-job">
        ...
        <h1 class="title">Post New Internship</h1>

        <p class="post-internship-p">Hiring interns on WUZZUF is always FREE to encourage you to try out new talent - Whether fresh grads or students.</p>
        ...
        <div class="box-job-details box-style-job">
            ...
            <h2 class="post-type-title">Internship Details</h2>
            ...
            <div class="job-category">
                ...
                <label for="">Internship Category<span>max. 3</span></label>
