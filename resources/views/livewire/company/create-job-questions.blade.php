...
">
    ...
    <form action="" wire:submit="save" method="POST" style="
    width: 100%;
    display: flex;
...
">
        ...
        <div class="about-questions box-style-job">
            ...
            <div class="about-questions-button">

                <button class="black-button" wire:click.prevent="">
                    <svg width="16" height="16" preserveAspectRatio="none" viewBox="0 0 24 24">
                ...
                <button class="gray-button" wire:click.prevent="">Preview Question</button>
            ...
            <div class="table-questions">
                ...
                <div class="table-questions-select-question">
                    ...
                    <div class="table-questions-select-question-ques">
